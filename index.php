    ...
    <header>
         <div class='header-top'>
           ...
           <div class='header-top-right'>
             ...
             <img src='https://lh3.googleusercontent.com/ogw/ADGmqu_yKNtzDxrtK_Vm3APP-R5c7KmWHrg8yoHGsbrp=s32-c-mo' alt=''>
           </div>
         </div>
         ...
         <?php
           $faqs = [
             [
               ...
               'answer' => '<p>The recent <span class=\'special-text\'>ruling by the Court of Justice of the European Union</span> has profound consequences for search engines in Europe. The court found that certain users have the right to ask search engines like Google to remove results for queries that include the person\'s name. To qualify, the results shown would need to be inadequate, irrelevant, no longer relevant, or excessive.</p>
             ...
             [
               ...
               <p>You can learn more about safety and security online, including how to protect yourself and your family online, at the <span class=\'special-text\'>Google Safety Center</span>.<br><br>
               <span class=\'special-text\'>Learn more</span> about how we keep your personal information private and safe — and put you in control.</p>'
             ],
             [
               'question' => 'Why is my account associated with a country?',
               'answer' => '<p>Your account is associated with a country (or territory) in the Terms of Service so that we can determine two things: <br><br>
               <ol><li>The Google affiliate that provides the services, that processes your information, and that is responsible for complying with applicable privacy laws. Generally, Google offers its consumer services through either of two companies:<br><br>
                 ...
                 <li>The version of the terms that govern our relationship, which can vary depending on local laws</li></ol></p>
                 ...
                 <div class=\'small-title\'>Determining the country associated with your account</div> <br><br>
